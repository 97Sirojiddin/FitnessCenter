      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          ...
          <?php if($_GET['page']=='profile'){ ?>
            ...
            <form method="POST" action="update.php" class="form-horizontal hms-form-register">
              <fieldset>
                <div class="col-md-12" style="padding-right: 35px;">
                  ...
                  <div class="form-group">
                   <label class="control-label" for="address1">E-mail</label>  
                      ...
                      <input id="email" name="email" type="text" placeholder="username@example.com" class="form-control hms-form-control input-md" required="">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" style="border-radius: 3px !important;">
        <div class="form-group">
          ...
          <input id="cpassword" name="cpassword" type="password" class="form-control hms-form-control input-md" required="">            
        </div>
        <div class="form-group">
          <label class="control-label" for="address1">New password</label>  
          <input id="npassword" name="npassword" type="password" class="form-control hms-form-control input-md" required="">            
        </div>


        <div class="form-group">
          <label class="control-label" for="address1">Confirm new password</label>  
          <input id="comfirm" name="comfirm" type="password" class="form-control hms-form-control input-md" required="">            
        </div>
      </div>
      <div class="modal-footer">
        <button id="btn_save" type="button" class="btn btn-success hms-btn-success" data-dismiss="modal">Save</button>
